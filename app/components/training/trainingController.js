basketballManagerApp.controller('trainingController',['$scope','$http','$modal', '$log',function ($scope,$http,$modal, $log) {

  $scope.tmpUrl ='app/shared/player/';

  $http.post('/assets/source/trainingData.json'/*, {msg:'hello word!'}*/).
